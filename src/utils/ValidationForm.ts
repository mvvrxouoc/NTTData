...
export const ValidationForm = (formValue: FormValues, formType: FormType): ErrorMessages => {
    ...
    const keys = Object.keys(formStructure) as Array<keyof typeof formStructure>; // Quiere decir que se crea un Array de keys del typeof(del tipo) de formStructure
